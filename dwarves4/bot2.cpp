...
{	
	...
	else
	{
		...
		if(ifDay(hours, minutes) == true && isfenceUp == false && dwarf.name() <= 3) //day time collect pumkpin of day 7 dwarves 0-3
		{
				int r = dwarf.row();
				int c = dwarf.col();
		...
		if(ifDay(hours, minutes) == true && dwarf.name() == 4 && ifmiddle == false && builtStartFence == false) //day time on day 7 dwarf 4 is not middle and didnt build first fence
		{
			//log << ifmiddle << endl;
			ifmiddle = true;
			//log << ifmiddle << endl;
		...
		if(ifDay(hours, minutes) == true && dwarf.name() == 4 && ifmiddle == true && builtStartFence == false) //day time on day 7 dwarf 4 is middle and build first fence
		{
			
			//int r = dwarf.row();
			//int c = dwarf.col();
					
			dwarf.start_build(directionEmpty(dwarf, r, c));	//dwarf 4 builds first 
			//log << "andndndnndnnd" << endl;
			builtStartFence = true;	
		}
		
		if(ifmiddle == true && builtStartFence == true)
		{}
	}
}
